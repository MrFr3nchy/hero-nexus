...
| [docs/handoff/the-sand-table/](docs/handoff/the-sand-table/README.md)       | A battle map, authored in 2D and rendered in 3D, with paper standees and doors that open. Eight phases built. |
