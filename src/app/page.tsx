...
import { DeckledEdge, Fleuron, SectionCard } from '@/@shared/components/ui';
...
export default function HomePage() {
  return (
    <main className="bg-bg">
      <section className="relative mx-auto max-w-4xl px-4 pb-16 pt-20 text-center sm:px-6 sm:pt-28">
        <Reveal>
          <p className="mb-4 font-display-alt text-xs uppercase tracking-[0.24em] text-gold">
            Self-hosted campaign tool
          </p>
          <h1 className="font-display-alt text-3xl leading-tight text-ink sm:text-5xl">
